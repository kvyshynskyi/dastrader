...
public enum TraderCommandType
{
    ...
    /// </summary>
    [Description("#LOGIN")] LOGIN_RESPONSE,
    ...
    ///     Does not work
    /// </summary>
    [Description("Order Server connection status")] ORDER_SERVER_CONNECTION_STATUS_COMMAND,
    /// <summary>
    ///     Order Server logon status
    ///     Does not work
    /// </summary>
    [Description("Order Server logon status")] ORDER_SERVER_LOGON_STATUS_COMMAND,
    /// <summary>
    ///     Quote Server connection status
    ///     Does not work
    /// </summary>
    [Description("Quote Server connection status")] QUOTE_SERVER_CONNECTION_STATUS_COMMAND,
    /// <summary>
    ///     Quote Server logon status
    ///     Does not work
    /// </summary>
    [Description("Quote Server logon status")]QUOTE_SERVER_LOGON_STATUS_COMMAND,
    ...
    ///     shortable etc.)
    /// </summary>
    [Description("%SLRET")] SLRET_RESPONSE,
    /// <summary>
    ///     #SLOrder
    ///     Mark the start when the server sends
    ///     short locate order list to the client.
    /// </summary>
    [Description("#SLOrder")] SLORDER_BEGIN_RESPONSE,
    /// <summary>
    ///     #SLOrderEnd (# LOrderEnd)
    ///     Mark the end when the server sends
    ///         short locate order list to the client.
    /// </summary>
    [Description("#SLOrderEnd")] SLORDER_END_RESPONSE,
    /// <summary>
    ///     # LOrderEnd
    ///     Mark the end when the server sends
    ///         short locate order list to the client.
    /// </summary>
    [Description("# LOrderEnd")] LORDER_END_RESPONSE,
    /// <summary>
    ///     %SLOrder
    ...
    /// </summary>
    [Description("%SLOrder")] SLORDER_RESPONSE,
    /// <summary>
    ///     SLAvailQuery
